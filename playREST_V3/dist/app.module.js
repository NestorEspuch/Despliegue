...
const juego_schema_1 = require("./juego/schemas/juego.schema");
const usuario_schema_1 = require("./usuario/schemas/usuario.schema");
...
AppModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            mongoose_1.MongooseModule.forRoot('mongodb://localhost:27017/playRest_v3'),
