...
export declare class JuegoService {
    ...
    listarId(id: string): Promise<import("mongoose").Document<unknown, any, Juego> & Juego & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    listarBuscado(buscar: string): Promise<(import("mongoose").Document<unknown, any, Juego> & Juego & {
        _id: import("mongoose").Types.ObjectId;
    })[]>;
    insertar(crearJuegoDto: JuegoDto): Promise<Juego>;
    actualizar(id: string, actualizarTareaDto: JuegoDto): Promise<Juego>;
